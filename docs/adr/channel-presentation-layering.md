...
- The ADR itself changes no runtime code.
- Runtime first stage landed separately in PR #55: presentation policy resolution + delivery mode + channel profiles, with defaults preserving prior behaviour.
